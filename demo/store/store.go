...
// New opens an in-memory SQLite DB, builds a dbuser.Store, seeds the demo
// accounts, and returns the store plus a Registry pre-populated with seeded IDs.
func New() (*dbuser.Store, *Registry, error) {
...
// dbuser.Store has no "list all users" API: register adds IDs, usersadmin lists them.
