...
// via a userauth.CodeVerifier and initiates by generating a code and handing
// it to a Deliverer.
type CodeMethod struct {
	MethodID string // MethodEmail, MethodSMS, or a custom ID
	Verifier userauth.CodeVerifier
	Issuer   CodeIssuer
...
func EmailCodeMethod(codes *userauth.VerificationCodeService, deliver userauth.Deliverer) CodeMethod {
